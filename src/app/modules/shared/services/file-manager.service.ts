...
export class FileManagerService {
  ...
  changeStatus(fileId: number) {
    return this.http.get(`${environment.ApiUrl}/api/FileManager/ChangeStatus/${fileId}`)
  }
  ...
  deleteByEntityName(entityId: any, entityName:string) {
    ...
    return this.http.post(`${environment.ApiUrl}/api/FileManager/DeleteByEntityName`,{entityName:entityName,entityId:entityId})
  }

  download(id: number) {
    this.http.get(`${environment.ApiUrl}/api/FileManager/Download/${id}`)
      .subscribe((res: any) => {
  ...
  getByEntityId(entityId: string) {
    return this.http.get(`${environment.ApiUrl}/api/FileManager/GetByEntityId/${entityId}`)
  }

  getByEntityName(entityName: string) {
    return this.http.get(`${environment.ApiUrl}/api/FileManager/GetByEntityName/${entityName}`)
  }
}
